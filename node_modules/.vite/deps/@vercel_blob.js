import { a as __toESM, n as __esmMin, r as __exportAll, t as __commonJSMin } from "./rolldown-runtime-FZ4Itg2g.js";
...
*/
//#endregion
//#region node_modules/@vercel/blob/dist/stream-browser.js
var import_is_buffer = /* @__PURE__ */ __toESM((/* @__PURE__ */ __commonJSMin(((exports, module) => {
...
//#endregion
//#region node_modules/jose/dist/browser/runtime/webcrypto.js
...
//#endregion
//#region node_modules/jose/dist/browser/runtime/digest.js
var digest;
...
//#endregion
//#region node_modules/jose/dist/browser/lib/buffer_utils.js
...
//#endregion
//#region node_modules/jose/dist/browser/runtime/base64url.js
var encodeBase64, encode$1, decodeBase64, decode$1;
var init_base64url$1 = __esmMin((() => {
	init_buffer_utils();
	encodeBase64 = (input) => {
		let unencoded = input;
...
//#endregion
//#region node_modules/jose/dist/browser/util/errors.js
...
//#endregion
//#region node_modules/jose/dist/browser/runtime/random.js
var random_default;
...
//#endregion
//#region node_modules/jose/dist/browser/lib/iv.js
...
var iv_default;
var init_iv = __esmMin((() => {
	init_errors();
	init_random();
	iv_default = (alg) => random_default(new Uint8Array(bitLength$1(alg) >> 3));
}));
//#endregion
//#region node_modules/jose/dist/browser/lib/check_iv_length.js
var checkIvLength;
var init_check_iv_length = __esmMin((() => {
	init_errors();
	init_iv();
	checkIvLength = (enc, iv) => {
		if (iv.length << 3 !== bitLength$1(enc)) throw new JWEInvalid("Invalid Initialization Vector length");
	};
}));
//#endregion
//#region node_modules/jose/dist/browser/runtime/check_cek_length.js
var checkCekLength;
var init_check_cek_length = __esmMin((() => {
	init_errors();
...
//#endregion
//#region node_modules/jose/dist/browser/runtime/timing_safe_equal.js
var timingSafeEqual;
var init_timing_safe_equal = __esmMin((() => {
	timingSafeEqual = (a, b) => {
...
//#endregion
//#region node_modules/jose/dist/browser/lib/crypto_key.js
...
var init_crypto_key = __esmMin((() => {}));
//#endregion
//#region node_modules/jose/dist/browser/lib/invalid_key_input.js
...
var init_invalid_key_input = __esmMin((() => {
	invalid_key_input_default = (actual, ...types) => {
		return message("Key must be ", actual, ...types);
	};
}));
//#endregion
//#region node_modules/jose/dist/browser/runtime/is_key_like.js
var is_key_like_default, types;
var init_is_key_like = __esmMin((() => {
	init_webcrypto();
...
//#endregion
//#region node_modules/jose/dist/browser/runtime/decrypt.js
async function cbcDecrypt(enc, cek, ciphertext, iv, tag, aad) {
	if (!(cek instanceof Uint8Array)) throw new TypeError(invalid_key_input_default(cek, "Uint8Array"));
	...
	let plaintext;
	try {
		plaintext = new Uint8Array(await webcrypto_default.subtle.decrypt({
			iv,
			name: "AES-CBC"
		}, encKey, ciphertext));
	} catch {}
...
async function gcmDecrypt(enc, cek, ciphertext, iv, tag, aad) {
	let encKey;
	if (cek instanceof Uint8Array) encKey = await webcrypto_default.subtle.importKey("raw", cek, "AES-GCM", false, ["decrypt"]);
	else {
...
var init_decrypt$4 = __esmMin((() => {
	...
	init_is_key_like();
	decrypt$2 = async (enc, cek, ciphertext, iv, tag, aad) => {
		if (!isCryptoKey(cek) && !(cek instanceof Uint8Array)) throw new TypeError(invalid_key_input_default(cek, ...types, "Uint8Array"));
...
//#endregion
//#region node_modules/jose/dist/browser/lib/is_disjoint.js
var isDisjoint;
var init_is_disjoint = __esmMin((() => {
	isDisjoint = (...headers) => {
...
//#endregion
//#region node_modules/jose/dist/browser/lib/is_object.js
...
var init_is_object = __esmMin((() => {}));
//#endregion
//#region node_modules/jose/dist/browser/runtime/bogus.js
var bogusWebCrypto;
var init_bogus = __esmMin((() => {
	bogusWebCrypto = [
		{
			hash: "SHA-256",
			name: "HMAC"
...
//#endregion
//#region node_modules/jose/dist/browser/runtime/aeskw.js
...
function getCryptoKey$2(key, alg, usage) {
	...
	if (key instanceof Uint8Array) return webcrypto_default.subtle.importKey("raw", key, "AES-KW", true, [usage]);
	throw new TypeError(invalid_key_input_default(key, ...types, "Uint8Array"));
}
var wrap$1, unwrap$1;
var init_aeskw = __esmMin((() => {
	init_bogus();
	init_webcrypto();
	init_crypto_key();
	init_invalid_key_input();
	init_is_key_like();
	wrap$1 = async (alg, key, cek) => {
		const cryptoKey = await getCryptoKey$2(key, alg, "wrapKey");
		checkKeySize(cryptoKey, alg);
		const cryptoKeyCek = await webcrypto_default.subtle.importKey("raw", cek, ...bogusWebCrypto);
		return new Uint8Array(await webcrypto_default.subtle.wrapKey("raw", cryptoKeyCek, cryptoKey, "AES-KW"));
	};
	unwrap$1 = async (alg, key, encryptedKey) => {
		const cryptoKey = await getCryptoKey$2(key, alg, "unwrapKey");
		checkKeySize(cryptoKey, alg);
		const cryptoKeyCek = await webcrypto_default.subtle.unwrapKey("raw", encryptedKey, cryptoKey, "AES-KW", ...bogusWebCrypto);
		return new Uint8Array(await webcrypto_default.subtle.exportKey("raw", cryptoKeyCek));
	};
}));
//#endregion
//#region node_modules/jose/dist/browser/runtime/ecdhes.js
async function deriveKey$1(publicKey, privateKey, algorithm, keyLength, apu = /* @__PURE__ */ new Uint8Array(0), apv = /* @__PURE__ */ new Uint8Array(0)) {
	if (!isCryptoKey(publicKey)) throw new TypeError(invalid_key_input_default(publicKey, ...types));
	checkEncCryptoKey(publicKey, "ECDH");
	if (!isCryptoKey(privateKey)) throw new TypeError(invalid_key_input_default(privateKey, ...types));
	...
	return concatKdf(new Uint8Array(await webcrypto_default.subtle.deriveBits({
		name: publicKey.algorithm.name,
		public: publicKey
	}, privateKey, length)), keyLength, value);
}
async function generateEpk(key) {
	if (!isCryptoKey(key)) throw new TypeError(invalid_key_input_default(key, ...types));
...
//#endregion
//#region node_modules/jose/dist/browser/lib/check_p2s.js
function checkP2s(p2s) {
	if (!(p2s instanceof Uint8Array) || p2s.length < 8) throw new JWEInvalid("PBES2 Salt Input must be 8 or more octets");
}
var init_check_p2s = __esmMin((() => {
	init_errors();
}));
//#endregion
//#region node_modules/jose/dist/browser/runtime/pbes2kw.js
function getCryptoKey$1(key, alg) {
	if (key instanceof Uint8Array) return webcrypto_default.subtle.importKey("raw", key, "PBKDF2", false, ["deriveBits"]);
	if (isCryptoKey(key)) {
...
async function deriveKey(p2s$1, alg, p2c, key) {
	...
	if (cryptoKey.usages.includes("deriveBits")) return new Uint8Array(await webcrypto_default.subtle.deriveBits(subtleAlg, cryptoKey, keylen));
	if (cryptoKey.usages.includes("deriveKey")) return webcrypto_default.subtle.deriveKey(subtleAlg, cryptoKey, wrapAlg, false, ["wrapKey", "unwrapKey"]);
	throw new TypeError("PBKDF2 key \"usages\" must include \"deriveBits\" or \"deriveKey\"");
}
var encrypt$2, decrypt$1;
var init_pbes2kw = __esmMin((() => {
	init_random();
	init_buffer_utils();
	init_base64url$1();
	init_aeskw();
	...
	init_invalid_key_input();
	init_is_key_like();
	encrypt$2 = async (alg, key, cek, p2c = 2048, p2s = random_default(/* @__PURE__ */ new Uint8Array(16))) => {
		const derived = await deriveKey(p2s, alg, p2c, key);
		return {
			encryptedKey: await wrap$1(alg.slice(-6), derived, cek),
			p2c,
			p2s: encode$1(p2s)
		};
	};
	decrypt$1 = async (alg, key, encryptedKey, p2c, p2s) => {
		const derived = await deriveKey(p2s, alg, p2c, key);
		return unwrap$1(alg.slice(-6), derived, encryptedKey);
	};
}));
//#endregion
//#region node_modules/jose/dist/browser/runtime/subtle_rsaes.js
...
var init_subtle_rsaes = __esmMin((() => {
	init_errors();
}));
//#endregion
//#region node_modules/jose/dist/browser/runtime/check_key_length.js
var check_key_length_default;
var init_check_key_length = __esmMin((() => {
...
//#endregion
//#region node_modules/jose/dist/browser/runtime/rsaes.js
var encrypt$1, decrypt;
var init_rsaes = __esmMin((() => {
	init_subtle_rsaes();
	init_bogus();
	init_webcrypto();
	init_crypto_key();
	...
	init_invalid_key_input();
	init_is_key_like();
	encrypt$1 = async (alg, key, cek) => {
		if (!isCryptoKey(key)) throw new TypeError(invalid_key_input_default(key, ...types));
		checkEncCryptoKey(key, alg, "encrypt", "wrapKey");
		check_key_length_default(alg, key);
		if (key.usages.includes("encrypt")) return new Uint8Array(await webcrypto_default.subtle.encrypt(subtleRsaEs(alg), key, cek));
	...
	decrypt = async (alg, key, encryptedKey) => {
		if (!isCryptoKey(key)) throw new TypeError(invalid_key_input_default(key, ...types));
		checkEncCryptoKey(key, alg, "decrypt", "unwrapKey");
		check_key_length_default(alg, key);
		if (key.usages.includes("decrypt")) return new Uint8Array(await webcrypto_default.subtle.decrypt(subtleRsaEs(alg), key, encryptedKey));
		if (key.usages.includes("unwrapKey")) {
			const cryptoKeyCek = await webcrypto_default.subtle.unwrapKey("raw", encryptedKey, key, subtleRsaEs(alg), ...bogusWebCrypto);
			return new Uint8Array(await webcrypto_default.subtle.exportKey("raw", cryptoKeyCek));
		}
...
//#endregion
//#region node_modules/jose/dist/browser/lib/is_jwk.js
function isJWK(key) {
...
var init_is_jwk = __esmMin((() => {
	init_is_object();
}));
//#endregion
//#region node_modules/jose/dist/browser/runtime/jwk_to_key.js
...
//#endregion
//#region node_modules/jose/dist/browser/runtime/normalize_key.js
...
var init_normalize_key = __esmMin((() => {
	init_is_jwk();
	init_base64url$1();
	init_jwk_to_key();
	exportKeyValue = (k) => decode$1(k);
	isKeyObject = (key) => {
		return key?.[Symbol.toStringTag] === "KeyObject";
	};
...
//#endregion
//#region node_modules/jose/dist/browser/lib/cek.js
...
var cek_default;
var init_cek = __esmMin((() => {
	init_errors();
	init_random();
	cek_default = (alg) => random_default(new Uint8Array(bitLength(alg) >> 3));
}));
//#endregion
//#region node_modules/jose/dist/browser/lib/format_pem.js
var format_pem_default;
var init_format_pem = __esmMin((() => {
	format_pem_default = (b64, descriptor) => {
		return `-----BEGIN ${descriptor}-----\n${(b64.match(/.{1,64}/g) || []).join("\n")}\n-----END ${descriptor}-----`;
	};
}));
//#endregion
//#region node_modules/jose/dist/browser/runtime/asn1.js
...
function getSPKI(x509) {
	return format_pem_default(spkiFromX509(decodeBase64(x509.replace(/(?:-----(?:BEGIN|END) CERTIFICATE-----|\s)/g, ""))), "PUBLIC KEY");
}
var genericExport, toSPKI, toPKCS8, findOid, getNamedCurve, genericImport, fromPKCS8, fromSPKI, fromX509;
var init_asn1 = __esmMin((() => {
	...
	getNamedCurve = (keyData) => {
		switch (true) {
			...
			default: throw new JOSENotSupported("Invalid or unsupported EC Key Curve or OKP Key Sub Type");
		}
	};
...
//#endregion
//#region node_modules/jose/dist/browser/key/import.js
...
//#endregion
//#region node_modules/jose/dist/browser/lib/check_key_type.js
...
var init_check_key_type = __esmMin((() => {
	init_invalid_key_input();
	init_is_key_like();
	init_is_jwk();
...
//#endregion
//#region node_modules/jose/dist/browser/runtime/encrypt.js
async function cbcEncrypt(enc, plaintext, cek, iv, aad) {
	...
	return {
		ciphertext,
		tag: new Uint8Array((await webcrypto_default.subtle.sign("HMAC", macKey, macData)).slice(0, keySize >> 3)),
		iv
	};
}
async function gcmEncrypt(enc, plaintext, cek, iv, aad) {
	let encKey;
	if (cek instanceof Uint8Array) encKey = await webcrypto_default.subtle.importKey("raw", cek, "AES-GCM", false, ["encrypt"]);
	else {
...
var init_encrypt$4 = __esmMin((() => {
	...
	init_errors();
	init_is_key_like();
	encrypt = async (enc, plaintext, cek, iv, aad) => {
		if (!isCryptoKey(cek) && !(cek instanceof Uint8Array)) throw new TypeError(invalid_key_input_default(cek, ...types, "Uint8Array"));
		if (iv) checkIvLength(enc, iv);
		else iv = iv_default(enc);
		switch (enc) {
			case "A128CBC-HS256":
			case "A192CBC-HS384":
			case "A256CBC-HS512":
...
//#endregion
//#region node_modules/jose/dist/browser/lib/aesgcmkw.js
async function wrap(alg, key, cek, iv) {
	const wrapped = await encrypt(alg.slice(0, 7), cek, key, iv, /* @__PURE__ */ new Uint8Array(0));
	return {
...
async function unwrap(alg, key, encryptedKey, iv, tag) {
	return decrypt$2(alg.slice(0, 7), key, encryptedKey, iv, tag, /* @__PURE__ */ new Uint8Array(0));
}
var init_aesgcmkw = __esmMin((() => {
	init_encrypt$4();
	init_decrypt$4();
	init_base64url$1();
}));
//#endregion
//#region node_modules/jose/dist/browser/lib/decrypt_key_management.js
...
var init_decrypt_key_management = __esmMin((() => {
	init_aeskw();
	init_ecdhes();
	init_pbes2kw();
	init_rsaes();
...
//#endregion
//#region node_modules/jose/dist/browser/lib/validate_crit.js
...
var init_validate_crit = __esmMin((() => {
	init_errors();
}));
//#endregion
//#region node_modules/jose/dist/browser/lib/validate_algorithms.js
var validateAlgorithms;
var init_validate_algorithms = __esmMin((() => {
...
//#endregion
//#region node_modules/jose/dist/browser/jwe/flattened/decrypt.js
async function flattenedDecrypt(jwe, key, options) {
	...
	let additionalData;
	if (jwe.aad !== void 0) additionalData = concat(protectedHeader, encoder.encode("."), encoder.encode(jwe.aad));
	...
	const result = { plaintext: await decrypt$2(enc, cek, ciphertext, iv, tag, additionalData) };
...
//#endregion
//#region node_modules/jose/dist/browser/jwe/compact/decrypt.js
...
//#endregion
//#region node_modules/jose/dist/browser/jwe/general/decrypt.js
...
//#endregion
//#region node_modules/jose/dist/browser/lib/private_symbols.js
var unprotected;
var init_private_symbols = __esmMin((() => {
	unprotected = Symbol();
}));
//#endregion
//#region node_modules/jose/dist/browser/runtime/key_to_jwk.js
var keyToJWK;
var init_key_to_jwk = __esmMin((() => {
	init_webcrypto();
	init_invalid_key_input();
	init_base64url$1();
	init_is_key_like();
	keyToJWK = async (key) => {
		...
		if (!isCryptoKey(key)) throw new TypeError(invalid_key_input_default(key, ...types, "Uint8Array"));
...
//#endregion
//#region node_modules/jose/dist/browser/key/export.js
...
//#endregion
//#region node_modules/jose/dist/browser/lib/encrypt_key_management.js
async function encryptKeyManagement(alg, enc, key, providedCek, providedParameters = {}) {
	...
	switch (alg) {
		...
		case "ECDH-ES+A256KW": {
			...
			encryptedKey = await wrap$1(alg.slice(-6), sharedSecret, cek);
			break;
		}
		case "RSA1_5":
		case "RSA-OAEP":
...
var init_encrypt_key_management = __esmMin((() => {
	init_aeskw();
	init_ecdhes();
	init_pbes2kw();
	init_rsaes();
...
//#endregion
//#region node_modules/jose/dist/browser/jwe/flattened/encrypt.js
...
var init_encrypt$3 = __esmMin((() => {
	...
	FlattenedEncrypt = class {
		...
		async encrypt(key, options) {
			if (!this._protectedHeader && !this._unprotectedHeader && !this._sharedUnprotectedHeader) throw new JWEInvalid("either setProtectedHeader, setUnprotectedHeader, or sharedUnprotectedHeader must be called before #encrypt()");
			if (!isDisjoint(this._protectedHeader, this._unprotectedHeader, this._sharedUnprotectedHeader)) throw new JWEInvalid("JWE Protected, JWE Shared Unprotected and JWE Per-Recipient Header Parameter names must be disjoint");
			const joseHeader = {
			...
			let cek;
			{
				...
				if (parameters) if (options && unprotected in options) if (!this._unprotectedHeader) this.setUnprotectedHeader(parameters);
			...
			let protectedHeader;
			let aadMember;
			if (this._protectedHeader) protectedHeader = encoder.encode(encode$1(JSON.stringify(this._protectedHeader)));
			...
			if (this._protectedHeader) jwe.protected = decoder.decode(protectedHeader);
...
//#endregion
//#region node_modules/jose/dist/browser/jwe/general/encrypt.js
...
var init_encrypt$2 = __esmMin((() => {
	...
	GeneralEncrypt = class {
		...
		async encrypt() {
			if (!this._recipients.length) throw new JWEInvalid("at least one recipient must be added");
			...
			for (let i = 0; i < this._recipients.length; i++) {
				...
				if (!isDisjoint(this._protectedHeader, this._unprotectedHeader, recipient.unprotectedHeader)) throw new JWEInvalid("JWE Protected, JWE Shared Unprotected and JWE Per-Recipient Header Parameter names must be disjoint");
				const joseHeader = {
					...this._protectedHeader,
					...this._unprotectedHeader,
				...
				validateCrit(JWEInvalid, /* @__PURE__ */ new Map(), recipient.options.crit, this._protectedHeader, joseHeader);
				if (joseHeader.zip !== void 0) throw new JOSENotSupported("JWE \"zip\" (Compression Algorithm) Header Parameter is not supported.");
			}
			...
			for (let i = 0; i < this._recipients.length; i++) {
				...
				const { encryptedKey, parameters } = await encryptKeyManagement(recipient.unprotectedHeader?.alg || this._protectedHeader?.alg || this._unprotectedHeader?.alg, enc, recipient.key, cek, { p2c });
...
//#endregion
//#region node_modules/jose/dist/browser/runtime/subtle_dsa.js
...
var init_subtle_dsa = __esmMin((() => {
	init_errors();
}));
//#endregion
//#region node_modules/jose/dist/browser/runtime/get_sign_verify_key.js
...
var init_get_sign_verify_key = __esmMin((() => {
	init_webcrypto();
	init_crypto_key();
	init_invalid_key_input();
	init_is_key_like();
...
//#endregion
//#region node_modules/jose/dist/browser/runtime/verify.js
var verify;
var init_verify$4 = __esmMin((() => {
	init_subtle_dsa();
	init_webcrypto();
	init_check_key_length();
...
//#endregion
//#region node_modules/jose/dist/browser/jws/flattened/verify.js
...
//#endregion
//#region node_modules/jose/dist/browser/jws/compact/verify.js
...
//#endregion
//#region node_modules/jose/dist/browser/jws/general/verify.js
...
//#endregion
//#region node_modules/jose/dist/browser/lib/epoch.js
var epoch_default;
var init_epoch = __esmMin((() => {
	epoch_default = (date) => Math.floor(date.getTime() / 1e3);
}));
//#endregion
//#region node_modules/jose/dist/browser/lib/secs.js
var minute, hour, day, week, year, REGEX, secs_default;
var init_secs = __esmMin((() => {
	minute = 60;
	hour = minute * 60;
	day = hour * 24;
	week = day * 7;
...
//#endregion
//#region node_modules/jose/dist/browser/lib/jwt_claims_set.js
...
//#endregion
//#region node_modules/jose/dist/browser/jwt/verify.js
...
//#endregion
//#region node_modules/jose/dist/browser/jwt/decrypt.js
...
//#endregion
//#region node_modules/jose/dist/browser/jwe/compact/encrypt.js
var CompactEncrypt;
...
//#endregion
//#region node_modules/jose/dist/browser/runtime/sign.js
var sign;
var init_sign$4 = __esmMin((() => {
	init_subtle_dsa();
	init_webcrypto();
	init_check_key_length();
	init_get_sign_verify_key();
...
//#endregion
//#region node_modules/jose/dist/browser/jws/flattened/sign.js
var FlattenedSign;
var init_sign$3 = __esmMin((() => {
	...
	FlattenedSign = class {
		...
		async sign(key, options) {
			...
			if (b64) payload = encoder.encode(encode$1(payload));
			let protectedHeader;
			if (this._protectedHeader) protectedHeader = encoder.encode(encode$1(JSON.stringify(this._protectedHeader)));
			else protectedHeader = encoder.encode("");
			const jws = {
				signature: encode$1(await sign(alg, key, concat(protectedHeader, encoder.encode("."), payload))),
				payload: ""
			};
...
//#endregion
//#region node_modules/jose/dist/browser/jws/compact/sign.js
var CompactSign;
...
//#endregion
//#region node_modules/jose/dist/browser/jws/general/sign.js
...
var init_sign$1 = __esmMin((() => {
	...
	GeneralSign = class {
		...
		async sign() {
			if (!this._signatures.length) throw new JWSInvalid("at least one signature must be added");
			const jws = {
				signatures: [],
				payload: ""
			};
...
//#endregion
//#region node_modules/jose/dist/browser/jwt/produce.js
function validateInput(label, input) {
	if (!Number.isFinite(input)) throw new TypeError(`Invalid ${label} input`);
	return input;
}
var ProduceJWT;
var init_produce = __esmMin((() => {
	init_epoch();
	init_is_object();
	init_secs();
	ProduceJWT = class {
...
//#endregion
//#region node_modules/jose/dist/browser/jwt/sign.js
var SignJWT;
...
//#endregion
//#region node_modules/jose/dist/browser/jwt/encrypt.js
var EncryptJWT;
...
//#endregion
//#region node_modules/jose/dist/browser/jwk/thumbprint.js
...
//#endregion
//#region node_modules/jose/dist/browser/jwk/embedded.js
...
//#endregion
//#region node_modules/jose/dist/browser/jwks/local.js
...
//#endregion
//#region node_modules/jose/dist/browser/runtime/fetch_jwks.js
var fetchJwks;
var init_fetch_jwks = __esmMin((() => {
	init_errors();
...
//#endregion
//#region node_modules/jose/dist/browser/jwks/remote.js
...
//#endregion
//#region node_modules/jose/dist/browser/jwt/unsecured.js
var UnsecuredJWT;
var init_unsecured = __esmMin((() => {
	...
	UnsecuredJWT = class extends ProduceJWT {
		encode() {
			return `${encode$1(JSON.stringify({ alg: "none" }))}.${encode$1(JSON.stringify(this._payload))}.`;
		}
		static decode(jwt, options) {
			...
			return {
				payload: jwt_claims_set_default(header, decode$1(encodedPayload), options),
				header
			};
		}
	};
...
//#endregion
//#region node_modules/jose/dist/browser/util/base64url.js
...
//#endregion
//#region node_modules/jose/dist/browser/util/decode_protected_header.js
...
//#endregion
//#region node_modules/jose/dist/browser/util/decode_jwt.js
...
//#endregion
//#region node_modules/jose/dist/browser/runtime/generate.js
		...
		case "EdDSA": {
			...
			switch (crv) {
				...
				case "Ed448":
					algorithm = { name: crv };
					break;
				default: throw new JOSENotSupported("Invalid or unsupported crv option provided");
			}
			break;
		}
		case "ECDH-ES":
		...
		case "ECDH-ES+A256KW": {
			...
			switch (crv) {
				...
				case "X448":
					algorithm = { name: crv };
					break;
				default: throw new JOSENotSupported("Invalid or unsupported crv option provided, supported values are P-256, P-384, P-521, X25519, and X448");
			}
			break;
		}
		default: throw new JOSENotSupported("Invalid or unsupported JWK \"alg\" (Algorithm) Parameter value");
...
//#endregion
//#region node_modules/jose/dist/browser/key/generate_key_pair.js
...
//#endregion
//#region node_modules/jose/dist/browser/key/generate_secret.js
...
//#endregion
//#region node_modules/jose/dist/browser/runtime/runtime.js
var runtime_default$1;
var init_runtime$1 = __esmMin((() => {
	runtime_default$1 = "WebCryptoAPI";
}));
//#endregion
//#region node_modules/jose/dist/browser/util/runtime.js
var runtime_default;
var init_runtime = __esmMin((() => {
	init_runtime$1();
	runtime_default = runtime_default$1;
}));
//#endregion
//#region node_modules/jose/dist/browser/index.js
...
var require_verify_vercel_oidc_token = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	...
	var VERCEL_OIDC_JWKS_URL = new URL("https://oidc.vercel.com/.well-known/jwks");
...
//#endregion
//#region node_modules/@vercel/oidc/dist/index-browser.js
...
//#endregion
//#region node_modules/@vercel/blob/dist/undici-browser.js
var import_index_browser = require_index_browser();
var import_lib = /* @__PURE__ */ __toESM(require_lib(), 1);
var fetch$1 = globalThis.fetch.bind(globalThis);
//#endregion
//#region node_modules/@vercel/blob/dist/chunk-CIIQSN42.js
...
var supportsNewBlobFromArrayBuffer = new Promise((resolve) => {
	try {
		...
		new Blob([helloAsArrayBuffer]).text().then((text) => {
			resolve(text === "hello");
		}).catch(() => {
			resolve(false);
		});
...
async function toReadableStream(value) {
	...
	let streamValue;
	if (value instanceof ArrayBuffer) streamValue = new Uint8Array(value);
	else if (isNodeJsBuffer(value)) streamValue = value;
	else streamValue = stringToUint8Array(value);
	if (await supportsNewBlobFromArrayBuffer) return new Blob([streamValue]).stream();
...
async function getVercelOidcToken() {
	try {
		const token = (await (0, import_index_browser.getVercelOidcToken)()).trim();
...
function bytes(val) {
	...
	let floatValue;
	let unit = "b";
	if (!results) floatValue = parseInt(val, 10);
	else {
...
function parseStoreIdFromDelegationToken(delegationToken) {
	...
	if (dot < 0) throw new BlobError("Invalid delegation token format.");
	...
	if (!parsed.storeId || typeof parsed.storeId !== "string") throw new BlobError("Delegation token payload is missing `storeId`.");
...
async function resolveBlobAuth(options) {
	var _a3, _b2;
	if (options == null ? void 0 : options.presignedUrlPayload) return {
		kind: "presigned",
		storeId: parseStoreIdFromDelegationToken(options.presignedUrlPayload.delegationToken)
	};
	...
	if (oidcToken) {
		...
		if (manualOidcToken) throw new BlobError("oidcToken was passed, but no storeId was found. Pass a `storeId` option or set `BLOB_STORE_ID` to use OIDC auth");
	}
	const readWrite = readEnv("BLOB_READ_WRITE_TOKEN");
	if (readWrite) return {
		kind: "readWrite",
		token: readWrite,
		storeId: parseStoreIdFromReadWriteToken(readWrite)
	};
...
var supportsRequestStreams = (() => {
	if (isNodeProcess()) return true;
	if (getApiUrl().startsWith("http://localhost")) return false;
...
function computeBodyLength(body) {
	...
	if ("byteLength" in body && typeof body.byteLength === "number") return body.byteLength;
	if ("size" in body && typeof body.size === "number") return body.size;
	return 0;
}
...
function isStream(value) {
	...
	if (isNodeJsReadableStream(value)) return true;
	return false;
}
var addPresignedParams = (url, presignedUrlPayload) => {
	const urlObj = new URL(url);
	for (const [key, value] of Object.entries(presignedUrlPayload.params)) urlObj.searchParams.set(key, value);
...
var _b;
try {
	if (((_a = process.env.DEBUG) == null ? void 0 : _a.includes("blob")) || ((_b = process.env.NEXT_PUBLIC_DEBUG) == null ? void 0 : _b.includes("blob"))) debugIsActive = true;
} catch {}
function debug(message, ...args) {
	if (debugIsActive) console.debug(`vercel-blob: ${message}`, ...args);
}
var _a2;
...
var blobXhr = async ({ input, init, onUploadProgress }) => {
	debug("using xhr");
	let body = null;
	if (init.body) if (isReadableStream(init.body)) body = await new Response(init.body).blob();
	else body = init.body;
...
var blobRequest = async ({ input, init, onUploadProgress }) => {
	if (onUploadProgress) {
		if (hasFetchWithUploadProgress) return blobFetch({
			input,
			init,
			onUploadProgress
		});
		if (hasXhr) return blobXhr({
			input,
			init,
			onUploadProgress
		});
	}
	if (hasFetch) return blobFetch({
		input,
		init
	});
	if (hasXhr) return blobXhr({
...
async function getBlobError(response) {
	...
	if ((message == null ? void 0 : message.includes("contentType")) && message.includes("is not allowed")) code = "content_type_not_allowed";
	...
	if (message === "Token expired") code = "client_token_expired";
	if (message == null ? void 0 : message.includes("the file length cannot be greater than")) code = "file_too_large";
	if ((message == null ? void 0 : message.startsWith("OIDC is enabled for this project, but not for the")) && message.includes("environment.")) code = "oidc_environment_not_allowed";
	let error;
	switch (code) {
...
async function requestApi(pathname, init, commandOptions) {
	...
	if (commandOptions == null ? void 0 : commandOptions.presignedUrlPayload) requestInput = addPresignedParams(requestInput, commandOptions.presignedUrlPayload);
	...
	if (init.body && sendBodyLength) bodyLength = computeBodyLength(init.body);
	if (commandOptions == null ? void 0 : commandOptions.onUploadProgress) commandOptions.onUploadProgress({
		loaded: 0,
		total: bodyLength,
		percentage: 0
	});
	const apiResponse = await (0, import_lib.default)(async (bail) => {
		let res;
		try {
			res = await blobRequest({
				...
				onUploadProgress: (commandOptions == null ? void 0 : commandOptions.onUploadProgress) ? (loaded) => {
					...
					if (percentage === 100 && bodyLength > 0) return;
			...
			if (isNetworkError(error2)) throw error2;
		...
		if (code === "unknown_error" || code === "service_unavailable" || code === "internal_server_error") throw error;
		bail(error);
	}, {
		retries: getRetries(),
		onRetry: (error) => {
			if (error instanceof Error) debug(`retrying API request to ${pathname}`, error.message);
			retryCount = retryCount + 1;
		}
	});
	if (!apiResponse) throw new BlobUnknownError();
	if (commandOptions == null ? void 0 : commandOptions.onUploadProgress) commandOptions.onUploadProgress({
		loaded: totalLoaded,
		total: totalLoaded,
		percentage: 100
...
function getProxyThroughAlternativeApiHeaderFromEnv() {
	const extraHeaders = {};
	try {
		if ("VERCEL_BLOB_PROXY_THROUGH_ALTERNATIVE_API" in process.env && process.env.VERCEL_BLOB_PROXY_THROUGH_ALTERNATIVE_API !== void 0) extraHeaders["x-proxy-through-alternative-api"] = process.env.VERCEL_BLOB_PROXY_THROUGH_ALTERNATIVE_API;
		else if ("NEXT_PUBLIC_VERCEL_BLOB_PROXY_THROUGH_ALTERNATIVE_API" in process.env && process.env.NEXT_PUBLIC_VERCEL_BLOB_PROXY_THROUGH_ALTERNATIVE_API !== void 0) extraHeaders["x-proxy-through-alternative-api"] = process.env.NEXT_PUBLIC_VERCEL_BLOB_PROXY_THROUGH_ALTERNATIVE_API;
	} catch {}
	return extraHeaders;
}
...
function createPutHeaders(allowedOptions, options) {
	...
	if (allowedOptions.includes("contentType") && options.contentType) headers[putOptionHeaderMap.contentType] = options.contentType;
	if (allowedOptions.includes("addRandomSuffix") && options.addRandomSuffix !== void 0) headers[putOptionHeaderMap.addRandomSuffix] = options.addRandomSuffix ? "1" : "0";
	if (allowedOptions.includes("ifMatch") && options.ifMatch) {
		if (options.allowOverwrite === false) throw new BlobError("ifMatch and allowOverwrite: false are contradictory. ifMatch is used for conditional overwrites, which requires allowOverwrite to be true.");
		headers[putOptionHeaderMap.ifMatch] = options.ifMatch;
		if (allowedOptions.includes("allowOverwrite") && options.allowOverwrite === void 0) headers[putOptionHeaderMap.allowOverwrite] = "1";
	}
	if (allowedOptions.includes("allowOverwrite") && options.allowOverwrite !== void 0) headers[putOptionHeaderMap.allowOverwrite] = options.allowOverwrite ? "1" : "0";
	if (allowedOptions.includes("cacheControlMaxAge") && options.cacheControlMaxAge !== void 0) headers[putOptionHeaderMap.cacheControlMaxAge] = options.cacheControlMaxAge.toString();
	return headers;
}
async function createPutOptions({ pathname, options, extraChecks, getToken }) {
	...
	if (pathname.length > 950) throw new BlobError(`pathname is too long, maximum length is 950`);
	for (const invalidCharacter of disallowedPathnameCharacters) if (pathname.includes(invalidCharacter)) throw new BlobError(`pathname cannot contain "${invalidCharacter}", please encode it if needed`);
	if (!options) throw new BlobError("missing options, see usage");
	if (options.access !== "public" && options.access !== "private") throw new BlobError("access must be \"private\" or \"public\", see https://vercel.com/docs/vercel-blob");
	if (extraChecks) extraChecks(options);
	if (getToken) options.token = await getToken(pathname, options);
	return options;
}
...
async function completeMultipartUpload$1({ uploadId, key, pathname, parts, headers, options }) {
	...
	try {
		...
		if (error instanceof TypeError && (error.message === "Failed to fetch" || error.message === "fetch failed")) throw new BlobServiceNotAvailable();
		else throw error;
	}
}
...
async function uploadPart$1({ uploadId, key, pathname, headers, options, internalAbortController = new AbortController(), part }) {
	...
	if ((_a3 = options.abortSignal) == null ? void 0 : _a3.aborted) handleAbort();
	else (_b2 = options.abortSignal) == null || _b2.addEventListener("abort", handleAbort);
...
function uploadAllParts({ uploadId, key, pathname, stream, headers, options, totalToLoad }) {
	...
	return new Promise((resolve, reject) => {
		...
		if (options.onUploadProgress) onUploadProgress = (0, import_throttleit.default)(() => {
			var _a3;
			...
			(_a3 = options.onUploadProgress) == null || _a3.call(options, {
				loaded,
				total,
				percentage
			});
		...
		async function read() {
			...
			reading = true;
			while (currentBytesInMemory < maxBytesInMemory && !rejected) try {
				...
				if (done) {
					...
					if (arrayBuffers.length > 0) {
						partsToUpload.push({
							...
							blob: new Blob(arrayBuffers, { type: "application/octet-stream" })
						});
						sendParts();
		...
		async function sendPart(part) {
			...
			try {
				...
				if (partsToUpload.length > 0) sendParts();
				if (doneReading) {
					if (activeUploads === 0) {
						reader.releaseLock();
						resolve(completedParts);
		...
		function sendParts() {
			...
			while (activeUploads < maxConcurrentUploads && partsToUpload.length > 0) {
				...
				if (partToSend) sendPart(partToSend);
			}
		}
		function cancel(error) {
			...
			internalAbortController.abort();
			reader.releaseLock();
			if (error instanceof TypeError && (error.message === "Failed to fetch" || error.message === "fetch failed")) reject(new BlobServiceNotAvailable());
			else reject(error);
		}
	});
}
...
function createPutMethod({ allowedOptions, getToken, getPresignedUrlPayload, extraChecks }) {
	return async function put(pathname, body, optionsInput) {
		if (!body) throw new BlobError("body is required");
		if (isPlainObject(body)) throw new BlobError("Body must be a string, buffer or stream. You sent a plain JavaScript object, double check what you're trying to upload.");
		const options = await createPutOptions({
			pathname,
			options: optionsInput,
		...
		const headers = createPutHeaders(allowedOptions, options);
		if (options.multipart === true) return uncontrolledMultipartUpload(pathname, body, headers, optionsWithPresignedUrlPayload);
		const onUploadProgress = options.onUploadProgress ? (0, import_throttleit.default)(options.onUploadProgress, 100) : void 0;
		const response = await requestApi(`/?${new URLSearchParams({ pathname }).toString()}`, {
			method: "PUT",
			body,
			headers,
			signal: options.abortSignal
...
function assertAllowedContentTypesSubset(optionsTypes, delegationTypes, label) {
	if (!(optionsTypes == null ? void 0 : optionsTypes.length)) return;
	if (!(delegationTypes == null ? void 0 : delegationTypes.length)) return;
	for (const ct of optionsTypes) if (!contentTypeAllowedByList(ct, delegationTypes)) throw new Error(`${label}: allowedContentTypes entry "${ct}" is not permitted by the delegation token.`);
}
function assertNumberSubset(name, optionVal, delegationVal, label, mode) {
	if (optionVal === void 0) return;
	if (delegationVal === void 0) return;
	if (mode === "lte" && optionVal > delegationVal) throw new Error(`${label}: ${name} must be \u2264 delegation (${String(delegationVal)}).`);
}
function isPlausibleAbsoluteUrl(s) {
	if (typeof URL !== "undefined" && typeof URL.canParse === "function") return URL.canParse(s);
	try {
		new URL(s);
		return true;
	} catch {
...
function validatePresignUrlOnUploadCompletedWire(opt, label) {
	if (!opt) return;
	if (typeof opt.callbackUrl !== "string" || opt.callbackUrl.length === 0) throw new Error(`${label}: onUploadCompleted.callbackUrl must be a non-empty string.`);
	if (opt.callbackUrl.length > MAX_PRESIGN_CALLBACK_URL_CHARS) throw new Error(`${label}: onUploadCompleted.callbackUrl is too long.`);
	if (!isPlausibleAbsoluteUrl(opt.callbackUrl)) throw new Error(`${label}: onUploadCompleted.callbackUrl must be a valid URL.`);
	if (opt.tokenPayload !== void 0 && opt.tokenPayload !== null) {
		if (typeof opt.tokenPayload !== "string") throw new Error(`${label}: onUploadCompleted.tokenPayload must be a string.`);
		if (opt.tokenPayload.length > MAX_PRESIGN_CALLBACK_TOKEN_PAYLOAD_CHARS) throw new Error(`${label}: onUploadCompleted.tokenPayload is too long.`);
	}
}
...
function validateUrlOnlyPresignUploadOptions(urlOptions, label) {
	if (urlOptions.cacheControlMaxAge !== void 0) {
		...
		if (!Number.isInteger(n) || n < 0 || n > MAX_PRESIGN_CACHE_CONTROL_MAX_AGE_SECONDS) throw new Error(`${label}: cacheControlMaxAge must be an integer between 0 and ${MAX_PRESIGN_CACHE_CONTROL_MAX_AGE_SECONDS}.`);
	}
	if (urlOptions.ifMatch !== void 0) {
		const im = urlOptions.ifMatch;
		if (typeof im !== "string" || im.length === 0) throw new Error(`${label}: ifMatch must be a non-empty string.`);
		if (im.length > MAX_PRESIGN_IF_MATCH_LENGTH) throw new Error(`${label}: ifMatch is too long.`);
		if (IF_MATCH_CONTROL_CHARS_RE.test(im)) throw new Error(`${label}: ifMatch contains disallowed control characters.`);
	}
}
...
function resolvePresignUrlValidUntilMs(args) {
	...
	if ((urlOptions == null ? void 0 : urlOptions.validUntil) !== void 0) {
		if (typeof urlOptions.validUntil !== "number" || !Number.isFinite(urlOptions.validUntil)) throw new Error("presignUrl: validUntil must be a finite number (ms).");
		t = Math.trunc(urlOptions.validUntil);
	} else t = Math.trunc(delegationValidUntil);
	if (Number.isFinite(delegationValidUntil)) t = Math.min(t, Math.trunc(delegationValidUntil));
	if (t <= nowMs) throw new Error("presignUrl: resolved URL expiry is not after the current time; issue a new delegation token or pass a later validUntil.");
	return t;
}
function buildPresignCanonicalQueryEntries(args) {
	...
	const entries = [];
	if (resolvedUntil < delegUntil) entries.push([BLOB_PRESIGN_QUERY_VALID_UNTIL, String(resolvedUntil)]);
	if (operation === "delete") {
		if ((urlOptions == null ? void 0 : urlOptions.ifMatch) !== void 0) entries.push([BLOB_PRESIGN_QUERY_IF_MATCH, urlOptions.ifMatch]);
		return entries;
	}
	if (operation !== "put" || !urlOptions) return entries;
	...
	if (urlOptions.allowedContentTypes !== void 0) {
		...
		if (csv.length > 16384) throw new Error(`${label}: allowedContentTypes query value is too long.`);
		entries.push([BLOB_PRESIGN_QUERY_ALLOWED_CONTENT_TYPES, csv]);
	}
	if (urlOptions.maximumSizeInBytes !== void 0) entries.push([BLOB_PRESIGN_QUERY_MAXIMUM_SIZE, String(Math.trunc(urlOptions.maximumSizeInBytes))]);
	if (urlOptions.addRandomSuffix !== void 0) entries.push([BLOB_PRESIGN_QUERY_ADD_RANDOM_SUFFIX, urlOptions.addRandomSuffix ? "true" : "false"]);
	if (urlOptions.allowOverwrite !== void 0) entries.push([BLOB_PRESIGN_QUERY_ALLOW_OVERWRITE, urlOptions.allowOverwrite ? "true" : "false"]);
	if (urlOptions.cacheControlMaxAge !== void 0) entries.push([BLOB_PRESIGN_QUERY_CACHE_CONTROL_MAX_AGE, String(Math.trunc(urlOptions.cacheControlMaxAge))]);
	if (urlOptions.ifMatch !== void 0) entries.push([BLOB_PRESIGN_QUERY_IF_MATCH, urlOptions.ifMatch]);
	if (urlOptions.onUploadCompleted !== void 0) {
		const { callbackUrl, tokenPayload } = urlOptions.onUploadCompleted;
		if (callbackUrl.length > MAX_PRESIGN_CALLBACK_URL_CHARS) throw new Error(`${label}: onUploadCompleted.callbackUrl is too long.`);
		entries.push([BLOB_PRESIGN_QUERY_CALLBACK_URL, callbackUrl]);
		if (tokenPayload !== void 0 && tokenPayload !== null && tokenPayload !== "") {
			if (tokenPayload.length > MAX_PRESIGN_CALLBACK_TOKEN_PAYLOAD_CHARS) throw new Error(`${label}: onUploadCompleted.tokenPayload is too long.`);
...
function assertIssueSignedTokenValidUntilOption(validUntil) {
	const now = Date.now();
	if (typeof validUntil !== "number" || !Number.isInteger(validUntil) || !Number.isFinite(validUntil)) throw new BlobError("`issueSignedToken`: validUntil must be an integer milliseconds timestamp.");
	if (validUntil <= now) throw new BlobError("`issueSignedToken`: validUntil must be in the future.");
}
async function issueSignedToken(options) {
	if (!options) throw new BlobError("`issueSignedToken` requires an options object");
	const body = {};
	if (options.pathname !== void 0) body.pathname = options.pathname;
	if (options.operations !== void 0) {
		if (options.operations.length === 0) throw new BlobError("`operations` must be a non-empty array if provided");
	...
	if (options.maximumSizeInBytes !== void 0) body.maximumSizeInBytes = options.maximumSizeInBytes;
	if (options.allowedContentTypes !== void 0) body.allowedContentTypes = options.allowedContentTypes;
...
function uint8ToBase64(bytes2) {
	...
	let s = "";
	for (let i = 0; i < bytes2.length; i++) s += String.fromCharCode(bytes2[i]);
	return btoa(s);
}
async function hmacSha256Base64Url(key, data) {
	var _a3;
	if (!((_a3 = globalThis.crypto) == null ? void 0 : _a3.subtle)) throw new BlobError("HMAC is not available: expected globalThis.crypto.subtle (Node 20+ or a modern browser).");
...
async function presign(signedToken, options) {
	var _a3, _b2, _c, _d;
	if (!(signedToken == null ? void 0 : signedToken.clientSigningToken) || !(signedToken == null ? void 0 : signedToken.delegationToken)) throw new BlobError("`clientSigningToken` and `delegationToken` from `issueSignedToken` are required.");
	const scope = tryDecodePayload(signedToken.delegationToken);
	if (!scope) throw new BlobError("Invalid or unreadable `delegationToken` payload.");
	const p = scope.pathname;
	if (p && p !== "*") {
		if (options.pathname !== p) throw new BlobError(`Blob path does not match the signed token scope; expected \`${p}\`, got \`${options.pathname}\`.`);
	}
	if (Number.isFinite(scope.validUntil) && Date.now() > scope.validUntil) throw new BlobError("The signed delegation has expired; issue a new token first.");
	if (options.operation === "get" && !((_a3 = scope.operations) == null ? void 0 : _a3.includes("get"))) throw new BlobError("The delegation token is not valid for `GET` requests. Include `\"get\"` in `operations` when calling `issueSignedToken`.");
	if (options.operation === "head" && !((_b2 = scope.operations) == null ? void 0 : _b2.includes("head"))) throw new BlobError("The delegation token is not valid for `HEAD` requests. Include `\"head\"` in `operations` when calling `issueSignedToken`.");
	if (options.operation === "put" && !((_c = scope.operations) == null ? void 0 : _c.includes("put"))) throw new BlobError("The delegation token is not valid for presigned write requests. Include `\"put\"` in `operations` when calling `issueSignedToken`.");
	if (options.operation === "delete" && !((_d = scope.operations) == null ? void 0 : _d.includes("delete"))) throw new BlobError("The delegation token is not valid for presigned delete requests. Include `\"delete\"` in `operations` when calling `issueSignedToken`.");
	...
	try {
		...
		throw new BlobError(e instanceof Error ? e.message : String(e));
	}
...
function buildPresignedPutUrl(pathname, presignedUrlPayload) {
	return addPresignedParams(getApiUrl(`/?${new URLSearchParams({ pathname }).toString()}`), presignedUrlPayload);
}
...
async function presignUrl(signedToken, options) {
	...
	if (options.operation === "get" || options.operation === "head") return { presignedUrl: buildPresignedGetUrl(options.pathname, payload, options) };
	if (options.operation === "put") return { presignedUrl: buildPresignedPutUrl(options.pathname, payload) };
	if (options.operation === "delete") return { presignedUrl: buildPresignedDeleteUrl(options.pathname, payload) };
...
async function createFolder(pathname, options = { access: "public" }) {
	...
	const response = await requestApi(`/?${new URLSearchParams({ pathname: folderPathname }).toString()}`, {
		method: "PUT",
		headers,
		signal: options.abortSignal
	}, options);
...
async function del(urlOrPathname, options) {
	...
	if ((options == null ? void 0 : options.ifMatch) && urls.length > 1) throw new BlobError("ifMatch can only be used when deleting a single URL.");
	const headers = { "content-type": "application/json" };
	if (options == null ? void 0 : options.ifMatch) headers["x-if-match"] = options.ifMatch;
...
async function get(urlOrPathname, options) {
	if (!urlOrPathname) throw new BlobError("url or pathname is required");
	if (!options) throw new BlobError("missing options, see usage");
	if (options.access !== "public" && options.access !== "private") throw new BlobError("access must be \"private\" or \"public\", see https://vercel.com/docs/vercel-blob");
	const auth = await resolveBlobAuth(options);
	if (auth.kind === "presigned") throw new BlobError("Presigned URLs are not supported for the get method");
	let blobUrl;
	let pathname;
	...
	if (isUrl(urlOrPathname)) {
		...
		try {
			...
			if (!hostname.endsWith(".blob.vercel-storage.com")) throw new BlobError("Invalid URL: the URL does not point to a Vercel Blob store. Use a pathname instead, see https://vercel.com/docs/vercel-blob");
		} catch (error) {
			if (error instanceof BlobError) throw error;
			throw new BlobError("Invalid URL: unable to parse the provided URL");
		}
	} else {
		if (!auth.storeId) throw new BlobError("Invalid token: unable to extract store ID");
	...
	const response = await fetch$1(fetchUrl, {
		method: "GET",
	...
	if (!response.ok) throw new BlobError(`Failed to fetch blob: ${response.status} ${response.statusText}`);
	const stream = response.body;
	if (!stream) throw new BlobError("Response body is null");
...
async function copy(fromUrlOrPathname, toPathname, options) {
	if (!options) throw new BlobError("missing options, see usage");
	if (options.access !== "public" && options.access !== "private") throw new BlobError("access must be \"private\" or \"public\", see https://vercel.com/docs/vercel-blob");
	if (toPathname.length > 950) throw new BlobError(`pathname is too long, maximum length is 950`);
	for (const invalidCharacter of disallowedPathnameCharacters) if (toPathname.includes(invalidCharacter)) throw new BlobError(`pathname cannot contain "${invalidCharacter}", please encode it if needed`);
	const headers = {};
	headers["x-vercel-blob-access"] = options.access;
	if (options.addRandomSuffix !== void 0) headers["x-add-random-suffix"] = options.addRandomSuffix ? "1" : "0";
	if (options.allowOverwrite !== void 0) headers["x-allow-overwrite"] = options.allowOverwrite ? "1" : "0";
	if (options.contentType) headers["x-content-type"] = options.contentType;
	if (options.cacheControlMaxAge !== void 0) headers["x-cache-control-max-age"] = options.cacheControlMaxAge.toString();
	if (options.ifMatch) headers["x-if-match"] = options.ifMatch;
	const response = await requestApi(`?${new URLSearchParams({
		pathname: toPathname,
...
async function rename(fromUrlOrPathname, toPathname, options) {
	...
	if (options.cacheControlMaxAge !== void 0) headers["x-cache-control-max-age"] = options.cacheControlMaxAge.toString();
	if (options.ifMatch) headers["x-if-match"] = options.ifMatch;
	const response = await requestApi(`/rename?${new URLSearchParams({
		pathname: toPathname,
		fromUrl: fromUrlOrPathname
	}).toString()}`, {
		method: "POST",
...
var createMultipartUpload = createCreateMultipartUploadMethod({ allowedOptions: [
	"cacheControlMaxAge",
	"addRandomSuffix",
	"allowOverwrite",
	"contentType",
...
var createMultipartUploader = createCreateMultipartUploaderMethod({ allowedOptions: [
	"cacheControlMaxAge",
	"addRandomSuffix",
	"allowOverwrite",
	"contentType",
...
var uploadPart = createUploadPartMethod({ allowedOptions: [
	"cacheControlMaxAge",
	"addRandomSuffix",
	"allowOverwrite",
	"contentType"
] });
var completeMultipartUpload = createCompleteMultipartUploadMethod({ allowedOptions: [
	"cacheControlMaxAge",
	"addRandomSuffix",
	"allowOverwrite",
	"contentType"
